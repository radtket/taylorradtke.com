...
export const IconAirplaneSend = () => (
  <svg viewBox="0 0 512 367.5" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M505.2 14.3a34.9 34.9 0 00-36.6-13.2L26.4 112.4a34.9 34.9 0 00-9.4 63.8l93.5 56.1v123a12.2 12.2 0 0019.7 9.6l87.7-68.3 72 43.2a34.9 34.9 0 0047.7-11.6l169.2-275a34.9 34.9 0 00-1.6-38.9zm-199.5 287l-109.6-65.8 111.2-95.8a4.2 4.2 0 00-4.3-7.1L133.6 198l-82.3-49.4L463.5 44.9z"
      fill="#fff"
    />
  </svg>
);
